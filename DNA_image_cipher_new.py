...
# Iterate over each pixel in the channels and apply sequential increment
    for y in range(height):
        for x in range(width):
            ...
            val_to_xor_r=cp[ctr] +4*cp[ctr+1] + 16*cp[ctr+2] +64*cp[ctr+3]
            #print("val to xor r")
            ctr=ctr+4
            #print(val_to_xor_r)
            val_to_xor_g=cp[ctr] +4*cp[ctr+1] + 16*cp[ctr+2] +64*cp[ctr+3]
            #print("val to xor g")
            #print(val_to_xor_g)
            ctr=ctr+4
            val_to_xor_b=cp[ctr] +4*cp[ctr+1] + 16*cp[ctr+2] +64*cp[ctr+3]
            #print("val to xor b ")
            #print(val_to_xor_b)
            #print(ctr)
...
encrypt_image(output_image, decrypted_image, cp)
print(f'Image encrypted and saved to {decrypted_image}')
