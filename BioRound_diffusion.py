...
def convert_to_binary_and_save(arr, output_file):
    # Dictionary to map each number to its binary representation
    binary_map = {
        0: "00",
        1: "01",
        2: "10",
    ...
    binary_string = ''.join([binary_map[num] for num in arr])
...
InputArray=[randint(0,3) for __ in range(64)]
OutputArray=Bio_Round(InputArray)

InputArray2=InputArray.copy()
InputArray2=convert_to_original_array(flip_one_bit(convert_to_binary_array(InputArray2)))

OutputArray2=Bio_Round(InputArray2)

arr1=convert_to_binary_array(OutputArray)
arr2=convert_to_binary_array(OutputArray2)
