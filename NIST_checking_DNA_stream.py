...
input_array=cp
# Output file path
output_file_path = '/Users/yashmakwana/Documents/binaryoutput/nist_check_new2.txt'

# Call the function to convert and save the binary string
convert_to_binary_and_save(input_array, output_file_path)

print(f"The binary string has been saved to {output_file_path}")
